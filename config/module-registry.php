...
return [
    ...
    'mega_menu' => ['title' => __('مگا منو', 'fandoogh'), 'description' => __('نمایش دسته‌بندی‌ها، زیر‌دسته‌ها و بنرهای ووکامرس در یک مگامنوی قابل تنظیم.', 'fandoogh'), 'icon' => 'dashicons-menu-alt3', 'version' => '1.0.0'],
