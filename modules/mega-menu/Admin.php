...
final class Admin
{
    ...
    {
        $fields = [
            'button_bg' => ['رنگ پس‌زمینه دکمه', 'color'], 'button_color' => ['رنگ متن دکمه', 'color'], 'button_hover' => ['رنگ هاور دکمه', 'color'], 'button_radius' => ['شعاع گوشه دکمه (px)', 'number'], 'button_padding' => ['پدینگ دکمه (px)', 'number'], 'button_font_size' => ['اندازه فونت دکمه (px)', 'number'],
            ...
            'sidebar_bg' => ['پس‌زمینه سایدبار', 'color'], 'sidebar_color' => ['رنگ متن سایدبار', 'color'], 'sidebar_hover' => ['رنگ هاور سایدبار', 'color'], 'sidebar_active' => ['رنگ حالت فعال سایدبار', 'color'], 'sidebar_font_size' => ['اندازه فونت سایدبار (px)', 'number'], 'sidebar_padding' => ['پدینگ آیتم سایدبار (px)', 'number'],
            'grid_columns' => ['تعداد ستون‌های گرید (۲ تا ۴)', 'number'], 'card_border' => ['رنگ حاشیه کارت', 'color'], 'card_hover_border' => ['رنگ حاشیه هاور کارت', 'color'], 'card_radius' => ['شعاع کارت (px)', 'number'], 'card_hover_shadow' => ['سایه هاور کارت', 'text'], 'card_title_size' => ['اندازه عنوان کارت (px)', 'number'], 'card_count_size' => ['اندازه تعداد محصول (px)', 'number'], 'image_size' => ['اندازه تصویر دسته (px)', 'number'],
