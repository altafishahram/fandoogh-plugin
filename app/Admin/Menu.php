...
final class Menu
{
    public function register(): void
    {
        ...
        add_submenu_page('fa', __('تنظیمات مگا منو', 'fandoogh'), __('تنظیمات مگا منو', 'fandoogh'), 'manage_options', 'fa-mega-menu', [$this, 'megaMenu']);
    ...
    public function megaMenu(): void { Dashboard::render(); }
